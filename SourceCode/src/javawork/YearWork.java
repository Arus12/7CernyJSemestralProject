...
public class YearWork {
    ...
    public static void mainStart() {
        /*TESTING
            INPUT
            ----------------
            double points[][] = {{0,0}{2,0},{0,2}};
            double testPoints[][] = {{1,1},{-1,0.45},{0.5,0.2},{2,2}};
            ----------------
            EXPECTING OUTPUT
            ----------------
            Uvnitr trojuhelniku lezi 1 bod
            Na hranici trojuhelniku lezi 1 bod
            Vne trojuhelniku lezi 2 bod
            -----------------
         */
        ...
        while (UI.wantContinue()) {
             ...
             */
            UI.getPoints(points);
            if (!isTriangle(points[0][0], points[0][1], points[1][0], points[1][1], points[2][0], points[2][1])) {
                System.out.println("Zadane body nejsou trojuhelnik");
     ...
     * @return boolean
     */
    private static boolean isTriangle(double x1, double y1,
            double x2, double y2,
            double x3, double y3) {
    ...
    /**
     * Check if point is on triangle That can be replace with if points is zero
     *
